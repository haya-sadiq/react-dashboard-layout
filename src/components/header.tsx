...
function Header(){
    ...
    >
      ...
      <div className="flex items-center gap-x-2 xs:gap-x-4 sm:gap-x-8">
        ...
        <div className="relative hidden sm:block">
          ...
          <input
            type="search"
            placeholder="Search..."
            className=" bg-yellow-200 px-8 py-2 rounded-md placeholder:text-yellow-700 focus:outline-yellow-800"
          />
        </div>
